...
Feature: WebdriverUniversity - Contact Us Page
    ...
    Background: Pre conditions
        # these steps will be executed before each scenario's steps
        Given I navigate to the webdriveruniversity homepage
        When I click on the contact us button

    Scenario: Valid Contact Us Form Submission
        # here, we specify our requirements.
        # they will be underlined in yellow, until we map these to the tests
        # these will be mapped to tests in ../support/step_definitions
